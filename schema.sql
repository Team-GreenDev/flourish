...
insert into users set id = "15", username = 'Mike Mil\'k', name_first = 'Mike', name_last = 'Bazile', total_like = 7, image_url = 'https://randomuser.me/api/portraits/men/12.jpg', bio = 'I really like plants';

/* add 5 posts */
INSERT INTO posts set user_id = "108191618273119179607", like_count = 0, url = 'https://hgtvhome.sndimg.com/content/dam/images/hgtv/products/2019/9/19/3/RX_1800Flowers_Money-Plant.jpg.rend.hgtvcom.616.616.suffix/1568931656068.jpeg', text = 'Looking like an indoor lily pad jungle', created_at = NOW(), tag = '#indoorlife';
...
INSERT INTO posts set user_id = "108191618273119179607", like_count = 0, url = 'https://watchandlearn.scholastic.com/content/dam/classroom-magazines/watchandlearn/videos/animals-and-plants/plants/what-are-plants-/english/wall-2018-whatareplantsmp4.transform/content-tile-large/image.png', text = 'Portrait mode on the new plant', created_at = NOW(), tag = '#portraitmode';
...
INSERT INTO posts set user_id = "5", like_count = 15, url = 'https://images.costco-static.com/ImageDelivery/imageService?profileId=12026540&itemId=1410176-847&recipeName=680', text = 'My new little addition to my porch!', created_at = NOW(), tag = '#lilfiddle';
...
insert into messages set user_id = '10', recipient_id = '108191618273119179607', created_at = '2020-05-25 12-00-12', text = 'Hey how are you doing?!';
...
insert into followers set user_id = '1', follower_id = '108191618273119179607';

/* Add new comments to posts */
insert into comments set user_id = '4', post_id = 9, comment_text = 'Sweet post!', created_at = NOW();
insert into comments set user_id = '2', post_id = 10, comment_text = 'Those look great! I love the arrangement', created_at = NOW();
insert into comments set user_id = '3', post_id = 10, comment_text = 'Love the colors', created_at = NOW();
insert into comments set user_id = '4', post_id = 10, comment_text = 'I need some of those plants', created_at = NOW();
insert into comments set user_id = '5', post_id = 10, comment_text = 'You do have an army!', created_at = NOW();
insert into comments set user_id = '4', post_id = 9, comment_text = 'Sweet post!', created_at = NOW();
insert into comments set user_id = '2', post_id = 8, comment_text = 'Those look great! I love the arrangement', created_at = NOW();
insert into comments set user_id = '3', post_id = 6, comment_text = 'Love the colors', created_at = NOW();
insert into comments set user_id = '4', post_id = 6, comment_text = 'I need some of those plants', created_at = NOW();
insert into comments set user_id = '4', post_id = 4, comment_text = 'Sweet post!', created_at = NOW();
insert into comments set user_id = '2', post_id = 4, comment_text = 'Those look great! I love the arrangement', created_at = NOW();
insert into comments set user_id = '3', post_id = 4, comment_text = 'Love the colors', created_at = NOW();
insert into comments set user_id = '4', post_id = 3, comment_text = 'I need some of those plants', created_at = NOW();
insert into comments set user_id = '2', post_id = 11, comment_text = 'Love the leaves', created_at = NOW();
insert into comments set user_id = '1', post_id = 11, comment_text = 'I need one of those plants', created_at = NOW();
